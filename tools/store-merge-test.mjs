...
봄('🔴 「정답 채우기」가 살아 있다', 있나('id="ic-ans"'));
/* 🔴 **주석이 아니라 «화면에 실제로 있는 것»을 붙든다** (2026-09-06에 바로잡았다).
   여기는 「남는 한도로 채우기」라는 글자를 찾고 있었는데, 그 글자는 단추가 아니라
   **머리말 주석**에만 있었다. 그래서 주석을 손질하자 검사가 깨졌다 —
   단추는 멀쩡한데. 검사가 «없어지면 안 되는 것»을 안 붙들고 있었던 것이다. */
봄('🔴 「자동 채우기」가 살아 있다', 있나('onclick="autoFillToggle()"'));
봄('🔴 「수식 다시 훑기」가 살아 있다', 있나('onclick="icRepairEq()"'));
{
