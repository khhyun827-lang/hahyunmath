...
봄('🔴 지난 주에 콕 집은 이틀이 정말 토·일이다', ['2026-09-19', '2026-09-20'].map(요일자), ['토', '일']);
/* 🔵 **2026-09-21(월)도 두 판이다** — 그 날 아침에 화면이 «똥피하기»로 떠 있었다(GAME_PICKS 가
   앞 주를 집은 탓에 번갈이가 어긋나 있었다). 이미 한 판 쓴 학생에게 «달리기» 한 판을 돌려준 것이다.
   ⚠ 이 줄은 지나가면 아무 일도 안 한다 — 지난 날의 n 은 이미 고정이다. */
봄('🔴 콕 집은 날이 셋이고 더 늘지 않았다', Object.keys(G.CK_PLAYS), ['2026-09-19', '2026-09-20', '2026-09-21']);
봄('월요일도 두 판 (게임이 바뀐 날이라 한 판 돌려준다)', G.ckPlaysAllowed('2026-09-21'), 2);
...
{
  for (const d of ['2026-09-18', '2026-09-22', '2026-09-26', '2026-09-27', '2026-10-03', '2026-10-04']) {
    오늘 = d;
